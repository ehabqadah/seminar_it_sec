...
\begin{figure}
  ...
  \centering
    \includegraphics[width=0.5\textwidth, height=0.4\textheight]{SVM.png}
...
\section{Standards	Used	in	Software	Vulnerability	Management}
 ...
 <cvss:generated-on-datetime>2017-01-11T14:37:58.247-05:00
       ...
       \end{lstlisting}
      \caption{CVSS score and metrics of the "CVE-2014-3299" vulenrability provided by NVD xml feed.}
       \end{figure}
